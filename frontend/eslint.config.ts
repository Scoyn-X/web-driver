...
export default [
  // 忽略文件配置
  {
    ignores: [
      ...
      "**/auto-imports.d.ts",
      "**/components.d.ts",
      // 测试与构建配置文件不纳入应用 eslint（不在 tsconfig 项目内，且由各自工具编译）
      "tests/**",
  ...
  // TypeScript 文件特定配置
  {
    ...
    rules: {
      // TypeScript 规则
      "@typescript-eslint/no-explicit-any": "off", // 允许使用 any 类型，方便开发
      ...
      "@typescript-eslint/consistent-type-imports": "off", // 关闭强制使用 type import
