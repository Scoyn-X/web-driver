package com.jiayuan.boot.common.result;
...
public enum ResultCode implements IResultCode {
    ...
    MAINLAND_ID_NUMBER_VERIFICATION_ILLEGAL("A0142", "大陆身份证 ID 校验非法"),
    ...
    EMAIL_ALREADY_EXISTS("A0154", "邮箱已被注册"),
    ...
    USER_OSS_CAPACITY_INSUFFICIENT("A0604", "用户OSS容量不足"),
    ...
    DOWNLOAD_FILE_EXCEPTION("A0720", "下载文件异常"),

    SHARE_EXCEPTION("A0730", "文件分享异常"),
    SHARE_NOT_FOUND("A0731", "分享不存在"),
    SHARE_EXPIRED("A0732", "该分享已过期"),
    SHARE_CANCELLED("A0733", "该分享已取消"),
    SHARE_FILE_DELETED("A0734", "该文件已被删除"),
    SHARE_EXTRACT_CODE_WRONG("A0735", "分享提取码错误"),
    SHARE_NOT_OWNER("A0736", "非分享创建者，无权操作"),
    ...
    USER_API_REQUEST_VERSION_NOT_MATCH("A0805", "用户API请求版本不匹配"),
    ...
    USER_GPS_POSITIONING_EXCEPTION("A1005", "用户GPS定位异常"),
